...
static constexpr ForwardIt is_sorted_until(ForwardIt first, ForwardIt last, Compare comp) {
    if (first != last) {
...
template <class BidirIt> static constexpr bool next_permutation(BidirIt first, BidirIt last) {
